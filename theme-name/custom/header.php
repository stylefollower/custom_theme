...
<head>
	...
	<?php wp_head(); ?>
	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/mystyle.css" type="text/css" />
</head>
...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<img id="headerBG" src="<?php header_image(); ?>" height="<?php echo get_custom_header()->height; ?>" width="<?php echo get_custom_header()->width; ?>" alt="" />
